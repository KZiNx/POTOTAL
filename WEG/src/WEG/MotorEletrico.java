...
/**
 * A classe MotorEletrico representa um tipo de produto da empresa WEG, especificamente um motor elétrico.
 */
public class MotorEletrico extends ProdutoWEG {
     ...
     *
     * @param tipoEnrolamento O tipo de enrolamento do motor elétrico a ser definido.
     */
     ...
     *
     * @param eficiência A eficiência do motor elétrico a ser definida.
     */
